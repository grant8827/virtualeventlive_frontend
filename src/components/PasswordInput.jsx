...
// A <input type="password"> with a show/hide toggle. Renders exactly like a
// plain input — pass the same className/props you'd give one — with an eye
// button overlaid on the right edge.
